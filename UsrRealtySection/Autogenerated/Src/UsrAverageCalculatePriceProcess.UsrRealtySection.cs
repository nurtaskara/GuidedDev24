namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrAverageCalculatePriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrAverageCalculatePriceProcessMethodsWrapper : ProcessModel
	{

		public UsrAverageCalculatePriceProcessMethodsWrapper(Process process)
			: base(process) {
