namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrAverageCalculatePriceProcessUsrRealtySection4MethodsWrapper

	/// <exclude/>
	public class UsrAverageCalculatePriceProcessUsrRealtySection4MethodsWrapper : ProcessModel
	{

		public UsrAverageCalculatePriceProcessUsrRealtySection4MethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			var esq = new EntitySchemaQuery(UserConnection.EntitySchemaManager, "UsrRealtySection");
