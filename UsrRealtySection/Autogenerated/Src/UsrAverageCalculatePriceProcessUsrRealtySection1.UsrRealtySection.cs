namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrAverageCalculatePriceProcessUsrRealtySection1MethodsWrapper

	/// <exclude/>
	public class UsrAverageCalculatePriceProcessUsrRealtySection1MethodsWrapper : ProcessModel
	{

		public UsrAverageCalculatePriceProcessUsrRealtySection1MethodsWrapper(Process process)
			: base(process) {
